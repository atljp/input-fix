...
/// Used for qbstructs
static void * (__cdecl * const qbMalloc)(size_t size, int unused) = reinterpret_cast<void * (__cdecl *)(size_t size, int unused)>(0x0040AC30);
    
// For freeing structures
static void (__cdecl * const FreeQBStruct)(void *memNode) = reinterpret_cast<void (__cdecl *)(void *memNode)>(0x0040DF10);
